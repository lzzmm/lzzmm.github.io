...
- Update font type 'Optima' and 'Source Han Serif SC'
- Hide zhcn index
...
- Add Google Scholar
- Deleted header image in index page

## 2023/10/25

- Update self intro
- Change self intro as index

## 2023/01/12 - 14

- Update font-awesome 4.3.0 -> 6.2.1
- Add sms links Jike & Jike Yellow page
- Add a friend Pseudoyu
- Start writing weekly review
- Fix bugs

## 2023/01/08

- Add `heading-font: CamingoCodeRegular`
- fix photo copyright sign
- fix other bugs
- optimized large size background images

## 2023/01/04

- Add `background-blend-mode: multiply;`
- Fix bugs
